...
class Enigma:
    ...
    def rotorConfigurationShift(self, startLetter, rotorConfiguration, offset):
    ...
    def encrypt(self, inputMessage, rotorSelection, rotorStartPos, plugboardSettings, reflectorSelection, ringSetting):
        ...
        UKWB = {"A": "Y", "Y": "A", "B": "R", "R": "B", "C": "U", "U": "C", "D": "H", "H": "D", "E": "Q", "Q": "E",
                "F": "S", "S": "F",
                "G": "L", "L": "G", "I": "P", "P": "I", "J": "X", "X": "J", "K": "N", "N": "K", "M": "O", "O": "M",
                "T": "Z", "Z": "T",
                "V": "W", "W": "V"}
        UKWC = {"A": "F", "F": "A", "B": "V", "V": "B", "C": "P", "P": "C", "D": "J", "J": "D", "E": "I", "I": "E",
                "G": "O", "O": "G",
                "H": "Y", "Y": "H", "K": "R", "R": "K", "L": "Z", "Z": "L", "M": "X", "X": "M", "N": "W", "W": "N",
                "Q": "T", "T": "Q",
                "S": "U", "U": "S"}
        ...
        tempA = rotorConfigDict.get(rotorSelection[0])
        tempB = rotorConfigDict.get(rotorSelection[1])
        tempC = rotorConfigDict.get(rotorSelection[2])
        ...
        startingAAlphabet = Enigma.alphabetRotation(self, rotorALetter)
        startingBAlphabet = Enigma.alphabetRotation(self, rotorBLetter)
        startingCAlphabet = Enigma.alphabetRotation(self, rotorCLetter)

        rotorAConfig = Enigma.rotorConfigurationShift(self, rotorALetter, tempA, ringSettingA)
        rotorBConfig = Enigma.rotorConfigurationShift(self, rotorBLetter, tempB, ringSettingB)
        rotorCConfig = Enigma.rotorConfigurationShift(self, rotorCLetter, tempC, ringSettingC)
