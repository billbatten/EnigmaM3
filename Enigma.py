...
#SHIFTS THE ROTOR CONFIG STRING DOWN 1 PLACE
    ...
    for letter in plaintext:
        ...
        if letter in alphabet:
            ...
            print("ROTOR C LETTER = ", rotorCLetter)
